  ...
  <div>
    ...
    <div v-show="!showBottom">
      ...
      <div v-show="bottomType === 'submit-artice'">
        <div v-transfer-dom>
          <popup v-model="showAgreement" height="80%">
            ...
            <div class="popup1">
              ...
              <p>2、甲方对投稿作品内容的真实性、合法性、准确性负责，保证其拥有可以在"一个南宁"发表该投稿作品的权利，并保证不侵犯任何第三方的著作权，否则，因甲方侵权行为产生的法律责任由甲方自行承担；若给乙方造成损失，乙方有权追究甲方的赔偿责任。</p>
              ...
              <p>2）文章当日阅读量在5~10W，稿费为500元。</p>
              <p>3）文章当日阅读量≥10W且转发人数＜1K，稿费为800元。</p>
              <p>4）文章当日阅读量≥10W且转发人数≥1K，稿费为1000元。</p>
        ...
        <div :class="'bottom_' + bottomType">
          <label class="bottom-agreement"><input type="checkbox" v-model="agreeValue"/><span>已阅读并同意《一个南宁投稿协议》</span></label>
          <div class="right-content">
